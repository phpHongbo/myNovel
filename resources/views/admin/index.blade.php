		...
		<nav id="Hui-userbar" class="nav navbar-nav navbar-userbar hidden-xs">
			<ul class="cl">
				...
				<li class="dropDown dropDown_hover">
					...
					<ul class="dropDown-menu menu radius box-shadow">
						<li><a href="javascript:;" onClick="myselfinfo('/ciwei/admin/myselfinfo')">个人信息</a></li>
						<li><a href="/ciwei/logout">切换账户</a></li>
						<li><a href="/ciwei/logout">退出</a></li>
				</ul>
			</li>
...
<aside class="Hui-aside">
	<div class="menu_dropdown bk_2">
		...
		<dl id="menu-member">
			...
			<dd>
				<ul>
					<li><a data-href="/ciwei/users" data-title="会员列表" href="javascript:;">会员列表</a></li>
	...
	<dl id="menu-admin">
		...
		<dd>
			<ul>
				<li><a data-href="/ciwei/admin" data-title="管理员列表" href="javascript:void(0)">管理员列表</a></li>
				<li><a data-href="/ciwei/admin/showpass" data-title="修改个人密码" href="javascript:void(0)">修改个人密码</a></li>
			</ul>
		</dd>
	</dl>
	<dl id="menu-admin">
		...
		<dd>
			<ul>
				<li><a data-href="/ciwei/role" data-title="角色列表" href="javascript:void(0)">权限列表</a></li>
				<li><a data-href="/ciwei/role/create" data-title="角色添加" href="javascript:void(0)">添加角色</a></li>
			</ul>
		</dd>
	</dl>
	<dl id="menu-admin">
		...
		<dd>
			<ul>
				<li><a data-href="/ciwei/node" data-title="权限列表" href="javascript:void(0)">权限列表</a></li>
				<li><a data-href="/ciwei/node/create" data-title="添加权限" href="javascript:void(0)">添加权限</a></li>
			</ul>
		</dd>
	</dl>
		<dl id="menu-tongji">
...
<section class="Hui-article-box">
	<div id="Hui-tabNav" class="Hui-tabNav hidden-xs">
		<div class="Hui-tabNav-wp">
			<ul id="min_title_list" class="acrossTab cl">
				<li class="active">
					<span title="我的桌面" data-href="/ciwei/welcome">我的桌面</span>
					<em></em></li>
		</ul>
	</div>
	...
	<div id="iframe_box" class="Hui-article">
		<div class="show_iframe">
			...
			<iframe scrolling="yes" frameborder="0" src="/ciwei/welcome"></iframe>
	</div>
</div>
</section>
