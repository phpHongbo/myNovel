...
<body>
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 推送管理 <span class="c-gray en">&gt;</span> Boss推荐管理 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
<div class="page-container">
	<div class="cl pd-5 bg-1 bk-gray mt-20"> <span class="l"> <a href="/ciwei/boss/create"  class="btn btn-primary radius"><i class="Hui-iconfont">&#xe600;</i> 添加推荐</a></span></div>
	<div class="mt-20">
	    <form action="/ciwei/boss" moethod="get">
          ...
          <table class="table table-border table-bordered table-bg table-hover table-sort">
			...
			@foreach($res as $v)
				<tr class="text-c">
					...
					<td class="td-manage">
					@if($v->status == 0)
					<a style="text-decoration:none" onClick="status_start(this,{{$v->id}})" href="javascript:;" title="显示"><i class="Hui-iconfont">&#xe631;</i></a>
					@else
					<a style="text-decoration:none" onClick="status_stop(this,{{$v->id}})" href="javascript:;" title="隐藏"><i class="Hui-iconfont">&#xe6e1;</i></a>
					@endif
					<a title="删除" href="javascript:;" onClick="tuijian_del(this,{{$v->id}})" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6e2;</i></a></td>
				</tr>
			@endforeach
			</tbody>
...
function tuijian_del (obj,id){
	layer.confirm('确认要删除吗？',function(index){
		layer.close(index);
			$.get('/ciwei/bossdel/',{id:id},function(data){
				if(data ==1){
