...
<article class="page-container">
	<form class="form form-horizontal" id="form-admin-add" action="/ciwei/admin/dopass" method="post">
	@if (count($errors) > 0)
	...
	<div class="row cl">
		...
		<div class="formControls col-xs-5 col-sm-5">
			<input type="password" class="input-text" value="" placeholder="" name="oldpassword">
		</div>
	</div>
	<div class="row cl">
